...
From there, I spent most of my time removing elements and copy. I chose familiar icons and set defaults I prefer for rewind, playback speed, and sleep timer. I didn't build any UI to change these, they're variables if you'd like customize it.
...
I considered using Origin Private File System OPFS because it didn't need user permissions, but this basically imports it into browser storage. Since there's not guarantee around storage size, I abandoned this too. It might be feasible for desktop, but my iPhone 17e with 100GB of free space only showed 3GB of available web storage. Some of my audiobooks are over a GB.
...
[^0]: https://www.audiobookshelf.org is a neat project and had a polished PWA. But I don't only occasionally get shared audiobooks and didn't want to self-host something this full featured.

...
[Planning Poker](http://planningpoker.com/) site to vote on suggested
...
to be at a place where people support this.

The meeting brought up a lot of vague and not fully defined problems
...
into are [Background
Job](http://codeforpeople.rubyforge.org/svn/bj/trunk/README) to
replace [BackgrounDRB](http://backgroundrb.rubyforge.org/), and
[Sphinx](http://www.sphinxsearch.com/) to replace [Acts as
Ferret](http://projects.jkraemer.net/acts_as_ferret/).

Originally I had planned to have one day this weekend dedicated to
...
next week will bring more updates in that area.
